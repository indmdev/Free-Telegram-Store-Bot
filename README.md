...
5. Navigate to the cloned directory by running "cd Free-Telegram-Store-Bot" (not "cd Free-Telegram-Store-Bot-main")
...
15. Run the "python store_main.py" command in your terminal from the "Free-Telegram-Store-Bot" folder
16. Completed
